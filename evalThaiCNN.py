...
#Check point file
tf.flags.DEFINE_string("checkpoint_dir", "/Users/liuyu/PycharmProjects/ThaiSyllableCNN/runs/1514963417/checkpoints", "Checkpoint directory from training run")
...
with graph.as_default():
    with tf.Session() as sess:
        ...
        for x_test_batch,y_test_batch,xs_test_batch in batches:
